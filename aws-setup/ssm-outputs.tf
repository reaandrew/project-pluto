...
resource "aws_ssm_parameter" "cert_eu_west_2" {
  ...
  tags        = { Name = "/website-agency/cert/wildcard_arn_eu_west_2" }
}

resource "aws_ssm_parameter" "cert_us_east_1" {
  name        = "/website-agency/cert/wildcard_arn_us_east_1"
  type        = "String"
  ...
  tags        = { Name = "/website-agency/cert/wildcard_arn_us_east_1" }
}
...
resource "aws_ssm_parameter" "cf_production" {
  ...
  tags        = { Name = "/website-agency/cf/production_distribution_id" }
}
...
resource "aws_ssm_parameter" "cf_preview" {
  ...
  tags        = { Name = "/website-agency/cf/preview_distribution_id" }
}

resource "aws_ssm_parameter" "cf_bff_production" {
  name        = "/website-agency/cf/bff_production_distribution_id"
  type        = "String"
  value       = aws_cloudfront_distribution.bff_production.id
  description = "CloudFront distribution id for production BFF"
  tags        = { Name = "/website-agency/cf/bff_production_distribution_id" }
}

resource "aws_ssm_parameter" "cf_bff_preview" {
  name        = "/website-agency/cf/bff_preview_distribution_id"
  type        = "String"
  ...
  tags        = { Name = "/website-agency/cf/bff_preview_distribution_id" }
}
...
resource "aws_ssm_parameter" "s3_production" {
  ...
  tags        = { Name = "/website-agency/s3/production_bucket" }
}
