...
# nosemgrep: terraform.aws.security.aws-cloudwatch-log-group-unencrypted.aws-cloudwatch-log-group-unencrypted
resource "aws_cloudwatch_log_group" "ses_feedback" {
  name              = "/aws/lambda/ai-website-agency-ses-feedback${local.env_suffix}"
  retention_in_days = 30
  tags              = local.common_tags
}

# nosemgrep: terraform.aws.security.aws-cloudwatch-log-group-unencrypted.aws-cloudwatch-log-group-unencrypted
resource "aws_cloudwatch_log_group" "reply_detector" {
  name              = "/aws/lambda/ai-website-agency-reply-detector${local.env_suffix}"
  retention_in_days = 30
  tags              = local.common_tags
}

# nosemgrep: terraform.aws.security.aws-cloudwatch-log-group-unencrypted.aws-cloudwatch-log-group-unencrypted
resource "aws_cloudwatch_log_group" "passcode_cleanup" {
  name              = "/aws/lambda/ai-website-agency-passcode-cleanup${local.env_suffix}"
  retention_in_days = 30
  tags              = local.common_tags
}

# nosemgrep: terraform.aws.security.aws-cloudwatch-log-group-unencrypted.aws-cloudwatch-log-group-unencrypted
resource "aws_cloudwatch_log_group" "reply_triage" {
  name              = "/aws/lambda/ai-website-agency-reply-triage${local.env_suffix}"
  retention_in_days = 30
  tags              = local.common_tags
}
...
# nosemgrep: terraform.aws.security.aws-cloudwatch-log-group-unencrypted.aws-cloudwatch-log-group-unencrypted
resource "aws_cloudwatch_log_group" "api_feedback" {
  name              = "/aws/lambda/ai-website-agency-api-feedback${local.env_suffix}"
  retention_in_days = 30
  tags              = local.common_tags
}

# nosemgrep: terraform.aws.security.aws-cloudwatch-log-group-unencrypted.aws-cloudwatch-log-group-unencrypted
resource "aws_cloudwatch_log_group" "api_tuners" {
  name              = "/aws/lambda/ai-website-agency-api-tuners${local.env_suffix}"
  retention_in_days = 30
  tags              = local.common_tags
}
